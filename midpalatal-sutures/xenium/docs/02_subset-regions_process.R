...
my_colors <- c("skyblue4","lemonchiffon","darkolivegreen2","goldenrod1","red2",
               "salmon2","seagreen","skyblue1","seagreen3","violet",
               "mediumpurple2","darkred","mediumpurple2","lightpink","blue",
               "royalblue2","lightcyan","magenta")
...
### Save file ---------------------------------------------------------------
outs <- here::here(section_folder, "data-output")

saveGiotto(gobject,foldername = outs,overwrite = FALSE)
...
my_colors <- c("darkolivegreen3","goldenrod1","mediumpurple2","dodgerblue","seagreen","red2","salmon2","mediumorchid","cyan","red2","seagreen")
...
UMAP_spatPlot <- plot_grid(p1,p2,ncol = 2)
filename <- paste0("05_", section, "_", region, "_combined_UMAP_spatPlot.png")
ggsave(file.path(results_folder, filename), UMAP_spatPlot, width = 7, height = 2.5, dpi = 300)


### Save file ---------------------------------------------------------------
# need to edit below function so that saves to region-7 folder 
# fixed?
